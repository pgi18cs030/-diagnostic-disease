...
def main():
   ...
   """
    ...
    Glucose=('Insert a Glucose',50,200)
    BP=('Insert a BP',50,200)
    SkinThickness=('Insert a SkinThickness',50,100)
    Insulin=('Insert a Insulin',50,1)
    BMI=('Insert a BMI',0,100)
    PedigreeFunction=('Insert a PedigreeFunction',0,100)
